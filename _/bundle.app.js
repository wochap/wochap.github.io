...
function PostsSchema({
  ...
  const postsSchemas = _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_9___default()(collection).call(collection, collectionItem => {
    const {
      frontMatter
    } = collectionItem;
